(() => {
  function t(t, n) {
    return t > 1024 && n > 1024
      ? { logoSize: 96, marginRight: 64, marginBottom: 64 }
      : { logoSize: 48, marginRight: 32, marginBottom: 32 };
  }
  function n(t, n, r) {
    const { logoSize: A, marginRight: o, marginBottom: i } = r;
    return { x: t - o - A, y: n - i - A, width: A, height: A };
  }
  var r = class r {
    constructor(t) {
      ((this.bgCaptures = t), (this.alphaMaps = {}));
    }
    static async create() {
      const t = new Image(),
        n = new Image();
    ...
    async getAlphaMap(t) {
      if (this.alphaMaps[t]) return this.alphaMaps[t];
      const n = 48 === t ? this.bgCaptures.bg48 : this.bgCaptures.bg96,
        r = document.createElement("canvas");
      ((r.width = t), (r.height = t));
      const A = r.getContext("2d");
      A.drawImage(n, 0, 0);
      const o = (function (t) {
        const { width: n, height: r, data: A } = t,
          o = new Float32Array(n * r);
        ...
        return o;
      })(A.getImageData(0, 0, t, t));
      return ((this.alphaMaps[t] = o), o);
    }
    async removeWatermarkFromImage(r) {
      const A = document.createElement("canvas");
      ((A.width = r.width), (A.height = r.height));
      const o = A.getContext("2d");
      o.drawImage(r, 0, 0);
      const i = o.getImageData(0, 0, A.width, A.height),
        a = t(A.width, A.height),
        q = n(A.width, A.height, a);
      return (
        (function (t, n, r) {
          const { x: A, y: o, width: i, height: a } = r;
          for (let r = 0; r < a; r++)
            for (let a = 0; a < i; a++) {
              const q = 4 * ((o + r) * t.width + (A + a));
              let e = n[r * i + a];
              if (e < 0.002) continue;
              e = Math.min(e, 0.99);
              const g = 1 - e;
              for (let n = 0; n < 3; n++) {
                const r = (t.data[q + n] - 255 * e) / g;
                t.data[q + n] = Math.max(0, Math.min(255, Math.round(r)));
              }
            }
        })(i, await this.getAlphaMap(a.logoSize), q),
        o.putImageData(i, 0, 0),
        A
      );
    }
    getWatermarkInfo(r, A) {
      const o = t(r, A),
        i = n(r, A, o);
      return { size: o.logoSize, position: i, config: o };
    }
  };
  ((window.WatermarkEngine = r),
    (window.GeminiWatermarkRemover = {
      WatermarkEngine: r,
      createEngine: () => r.create(),
    }));
})();
